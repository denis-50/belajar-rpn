...
console.log("Second Word: " + exampleSeconWord);
...
let exampleThridWord3 = word3.substring(15, 17);
...
console.log("Third Word: " + exampleThridWord3);
console.log("Fourth Word: " + exampleFourthWord3);
console.log("Fourth Word: " + exampleFifthWord3);
*/
...
console.log(
  "First Word: " + exampleThirdWord4 + ", with length: " + ThirdWordLength
);
console.log(
  "First Word: " + exampleFourthWord4 + ", with length: " + FourthWordLength
);
console.log(
